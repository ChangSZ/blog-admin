<template>
    <div>
        <Card>
            <div>
                <Form ref="formValidate" label-position="left" :model="formValidate" :rules="ruleValidate"
                    :label-width="80">
                    ...
                    <FormItem label="Category" prop="category">
                        <Select v-model="formValidate.category" placeholder="Select your category">
                            <Option v-for="item in categories" :value="item.cates.ID" :key="item.cates.ID"><span
                                    v-html="item.html"></span>{{ item.cates.DisplayName }}</Option>
                        </Select>
                    </FormItem>
                    ...
                    <FormItem label="Summary" prop="summary">
                        <Input v-model="formValidate.summary" type="textarea" :autosize="{ minRows: 2 }"
                            placeholder="Enter summary..."></Input>
                    </FormItem>
...
<script>
import { PostEdit, PostUpdate } from '@/api/post';
