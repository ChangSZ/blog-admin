    ...
    return {
      ...
      ruleValidate: {
        ...
        keywords: [
          {
            required: true,
            message: "The keywords cannot be empty",
            trigger: "blur",
          },
          {
            max: 100,
            message: "The keywords length is too long",
            trigger: "blur",
          },
        ],
        description: [
          ...
          {
            max: 200,
            message: "The description length is too long",
            trigger: "blur",
          },
        ],
        recordNumber: [
          {
            required: true,
            message: "The recordNumber can not be empty",
            trigger: "blur",
          },
          {
            max: 50,
            message: "The recordNumber length is too long",
            trigger: "blur",
          },
        ],
        theme: [
          ...
          {
            type: "integer",
            message: "Please select the theme",
            trigger: "change",
          },
        ],
      },
      ...
      this.$refs[name].validate((valid) => {
        if (valid) {
          SystemUpdate(
            ...
            that.formValidate.keywords,
            that.formValidate.description,
            that.formValidate.recordNumber,
            that.formValidate.theme
          )
            .then((res) => {
              if (res.data.code === 0) {
